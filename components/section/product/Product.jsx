...
export function Product({ image, name, price }) {
  ...
  return (
    <div className="mb-7 flex flex-col items-center justify-center md:mb-0 shadow-product-line relative">
      <div className="hover-parent">
        ...
        <div className="hover-child-2 absolute top-1/3 left-0 right-0 flex items-center justify-evenly">
          <div className="text-black w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-product-line hover:bg-primary relative icon-cart">
            <Link href={session ? "/shopping-cart" : "/login"}>
              <FaShoppingCart />
            </Link>
          </div>
          <div className="text-black w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-product-line hover:bg-primary relative icon-compare">
            <Link href="/compare">
              <DiGitCompare />
            </Link>
          </div>
